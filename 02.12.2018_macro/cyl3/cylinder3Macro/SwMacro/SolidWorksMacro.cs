...
namespace cylinder3Macro.csproj
{
    public partial class SolidWorksMacro
    {
        ...
        public void Main()
        {
            ...
            skSegment = ((SketchSegment)(swDoc.SketchManager.CreateCircle(0, 0, 0, 0.026638, 0.00194, 0)));
            swDoc.ClearSelection2(true);
            swDoc.SetPickMode();
            swDoc.ClearSelection2(true);
            swDoc.SketchManager.InsertSketch(true);
            ...
            swDoc.SketchManager.InsertSketch(true);
            swDoc.ClearSelection2(true);
            skSegment = ((SketchSegment)(swDoc.SketchManager.CreateCircle(0, 0, 0, 0.024569, 0.000647, 0)));
            swDoc.ClearSelection2(true);
            swDoc.SketchManager.InsertSketch(true);
            // 
            // Named View
